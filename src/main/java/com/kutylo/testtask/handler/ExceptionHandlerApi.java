package com.kutylo.testtask.handler;

import com.kutylo.testtask.handler.error.ApiError;
import com.kutylo.testtask.handler.error.ApiSubError;
import com.kutylo.testtask.handler.error.ApiValidationError;
...
public class ExceptionHandlerApi extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(FixerException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    protected ApiError handleFixerExceptions(FixerException exception) {
